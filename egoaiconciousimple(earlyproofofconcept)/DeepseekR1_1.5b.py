...
def run_advanced_simulation(domain: str = "financial_analysis", num_experiences: int = 15, use_mock: bool = False, use_real_data: bool = True):
    """Run advanced persistent identity simulation with real-time data"""
...
if __name__ == "__main__":
    ...
    print("1. Advanced DeepSeek R1 + Real-time data (Full system)")
    print("2. Advanced DeepSeek R1 + Demo data (Fast testing)")
    print("3. Mock mode + Real-time data (Demo with real feeds)")
    print("4. Mock mode + Demo data (Fastest demo)")
    print("5. Analyze existing data only")
    ...
    # Parse choices
    use_mock_mode = choice in ["3", "4"]
    use_real_data = choice in ["1", "3"]
    
    print(f"\nConfiguration:")
    print(f"  LLM: {'Mock (Demo)' if use_mock_mode else 'DeepSeek R1 (Real)'}")
    ...
    print(f"  DeepSeek R1: {not use_mock_mode}")
    ...
    print(f"Mode: {'Real AI + Real Data' if not use_mock_mode and use_real_data else 'Demo Mode'}")
    print()
    ...
    print("\n🔬 For detailed analysis, run the script again and choose option 5")
    ...
    print()
    print("3. Optional API keys for enhanced data:")
    print("   - NewsAPI: https://newsapi.org/register")
    print("   - Alpha Vantage: https://www.alphavantage.co/support/#api-key")
    print("   - FRED: https://fred.stlouisfed.org/docs/api/api_key.html")
    print()
    print("🚀 Ready to validate persistent identity formation with real-world data!")